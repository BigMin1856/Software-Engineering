...
#firechat .btn {
  ...
  *zoom: 1;
  ...
  background-image: -moz-linear-gradient(top, rgb(28, 173, 23), rgb(56, 118, 29));
  background-image: -webkit-gradient(linear, 0 0, 0 100%, from( rgb(28, 173, 23)), to(rgb(56, 118, 29)));
  background-image: -webkit-linear-gradient(top, rgb(28, 173, 23), rgb(56, 118, 29));
  background-image: -o-linear-gradient(top, rgb(28, 173, 23), rgb(56, 118, 29));
  background-image: linear-gradient(to bottom, rgb(28, 173, 23), rgb(56, 118, 29));
  background-repeat: repeat-x;
  filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#ffffffff', endColorstr='#ffe6e6e6', GradientType=0);
  border-color: #666666;
  border-color: rgba(40, 40, 40, 0.1) rgba(40, 40, 40, 0.1) rgba(40, 40, 40, 0.25);
...
#firechat .btn[disabled] {
  ...
  *background-color: rgb(30, 239, 24);
  outline: 0;
}
#firechat .btn:active,
#firechat .btn.active {
...
#firechat .btn:active {
  background-image: none;
  outline: 0;
  -webkit-box-shadow: inset 0 2px 4px rgba(56, 118, 29, 0.65), 0 1px 2px rgba(56, 118, 29, 0.5);
  -moz-box-shadow: inset 0 2px 4px rgba(56, 118, 29, 0.65), 0 1px 2px rgba(56, 118, 29, 0.5);
  box-shadow: inset 0 2px 4px rgba(56, 118, 29, 0.65), 0 1px 2px rgba(56, 118, 29, 0.5);
}
#firechat .btn.disabled,
#firechat .btn[disabled] {
  cursor: default;
